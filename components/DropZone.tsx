...
//   TO DOWNLOAD OUR FILES WHEN CONVERTED
  ...
  // CODE WORK FOR UPLOADING OUR FILES IN OUR DROP BOX
  ...
  // TO EXIST HOVER ON OUR DROPBOX AND AS CONDITIONS 
  const handleExitHover = (): void => setIsHover(false);

  //  ACTIONS--ARRAY INCREMENT
  ...
  // CHECKER- TO SEE IF WE HAVE FILE THAT IS READY FOR CONVERSION
  ...
  // lOADER OF OUR FILE WHEN WE CONVERT
  const load = async () => {
  ...
  // returns
//   WHAT WILL BE DISPLAYED IF WE NOW HAVE ACTIONS ARRAY
  if (actions.length) {
    return (
      <div className="space-y-6">
        {actions.map((action: Action, i: any) => (
          ...
          >
            ...
            {/* ERROR HANDLING WHEN WE HIT CONVERT BUTTON */}
            {action.is_error ? (
              ...
              <Badge variant="default" className="flex gap-2">
                ...
                // OUR SELECT FILED WHERE WE CAN THEN CHOOSE WHICH WHICH KEY OF CONVERSION WE WANT
              <div className="text-gray-400 text-md flex items-center gap-4">
                <span>Convert to</span>
                <Select
                  onValueChange={(value) => {
                    // INITIALIZATION OF  AUDIO, IMAGE, VIDEO FILES SELECTED OR DROP
                ...
                >
                  ...
                  <SelectContent className="h-fit">
                    ...
                    {/* FOR VIDEO DISPLAY ON OUR SELECT FILED */}
                    {action.file_type.includes("video") && (
                      <Tabs defaultValue={defaultValues} className="w-full">
                        ...
                        {/* CONTENTS THAT IS TO BE DISPLAYED FOR AUDIO AND VIDEO   */}
                        {/* VIDEO */}
                    ...
                    {/* FOR AUDIO FILE TO BE CONVERTED___DISPLAY VIEW */}
